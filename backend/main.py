...
# )
# print("Index Params Type:", type(index_params))
# print("Index Params Content:", index_params)
...
# #     try:
# #         data = request.json
# #         print("Received query:", data)  # Debugging
...
# #         # 🛠️ **Load Collection Before Search**
# #         client.load_collection(COLLECTION_NAME)
...
# #         candidates = [hit["metadata"] for hit in search_results[0]]
# #         print("Search results:", candidates)  # Debugging
...
#     # client.load_collection(COLLECTION_NAME)  # Ensure collection exists before starting
